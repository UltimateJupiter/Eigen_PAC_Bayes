...
sd_sgd_sol = 'experiment_log/run_1/models/epoch20.pth'
...
def main():
    ...
    HPB.optimize_PACB_RMSprop(learning_rate=0.001, epoch_num=1000, lr_decay_mode='step', lr_gamma=0.1, step_lr_decay=500)
